export {
  DEPARTMENTS, ASSET_STATUS, STATUS_OPTIONS, STATUS_COLORS,
  HISTORY_TYPES, HISTORY_STYLES, ASSET_TYPES, ROLES,
  REQUEST_TYPES, REQUEST_STYLES, REQUEST_STATUS_STYLES, C  // ← 두 개 추가
};
